...
public class CompanyPracticumShowtTest extends TestHarness {
	...
	public void test100Positive(final int practicumRecordIndex, final String code, final String title, final String abstractStr, final String goals, final String published, final String course, final String minus10estimatedTime,
