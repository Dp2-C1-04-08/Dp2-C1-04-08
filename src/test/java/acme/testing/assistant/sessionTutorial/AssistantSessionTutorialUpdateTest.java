...
public class AssistantSessionTutorialUpdateTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/assistant/session-tutorial/update-positive.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/assistant/session-tutorial/update-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	...
	public void test300Hacking() {
		...
		for (final SessionTutorial session : sessions) {
			...
			super.request("/assistant/session-tutorial/update", query);
