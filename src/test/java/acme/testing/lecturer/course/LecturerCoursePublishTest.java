...
public class LecturerCoursePublishTest extends TestHarness {
	...
	public void test100Positive(final int courseRecord, final String reference) {
		...
		super.checkColumnHasValue(courseRecord, 0, reference);
	...
	public void test200Negative(final int courseRecord, final String reference) {
