...
<acme:form readonly="${readonly}">
	...
	<acme:input-moment code="administrator.banner.form.label.start-date" path="startDate"/>
	<acme:input-moment code="administrator.banner.form.label.end-date" path="endDate"/>
